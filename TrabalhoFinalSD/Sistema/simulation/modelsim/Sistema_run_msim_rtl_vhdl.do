...
vcom -93 -work work {C:/TrabalhoFinalSD/Controladora/Controladora.vhd}
vcom -93 -work work {C:/TrabalhoFinalSD/Contador/Contador.vhd}
vcom -93 -work work {C:/TrabalhoFinalSD/Sistema/sistema.vhd}

vcom -93 -work work {C:/TrabalhoFinalSD/Sistema/tb_Sistema.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii -L rtl_work -L work -voptargs="+acc"  tb_Sistema
